...
CREATE TABLE IF NOT EXISTS @Tabela_Processamento (
   SEQUENCIA                  INTEGER
  ,FIELD_01                   varchar(008) default NULL
  ,FIELD_02                   varchar(008) default NULL
  ,FIELD_03                   varchar(008) default NULL
  ,FIELD_04                   varchar(008) default NULL
  ,FIELD_05                   varchar(008) default NULL
  ,FIELD_06                   varchar(008) default NULL
  ,FIELD_07                   varchar(008) default NULL
  ,FIELD_08                   varchar(008) default NULL
  ,FIELD_09                   varchar(008) default NULL
  ,FIELD_10                   varchar(008) default NULL
  ,FIELD_11                   varchar(008) default NULL
